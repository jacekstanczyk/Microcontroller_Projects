...
void WlaczLCD(){
    ...
    // ustawienie kirunku wyjściowego linii podłączonych do LCD
    TRIS_RS_LCD = 0;
    TRIS_EN_LCD = 0;
    TRIS_DB7_LCD = 0;
    TRIS_DB6_LCD = 0;
    ...
    // potwierdź zboczem opadającym EN sekwencję 0011
    EN_LCD = 0;
    
    // poczekaj co najmniej 100 us
    __delay_us(100);
    ...
    // potwierdź zboczem opadającym sekwencję 0011
    EN_LCD = 0;
    ...
    // bit 2 - 1 (inkrementacja adresu zapisu danych)
